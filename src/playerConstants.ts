...
export const thumbnailCacheVersion = "v3";
export const thumbnailWidth = 480;
export const thumbnailHeight = 270;
export const playlistThumbnailWidth = 240;
export const playlistThumbnailHeight = 135;
...
export const thumbnailLookupConcurrency = 8;
export const thumbnailGenerationConcurrency = 2;
export const thumbnailCommitBatchSize = 2;
export const playlistScrollFrameDelay = 16;
export const playlistThumbnailScrollIdleDelay = 140;
export const danmakuSpeedMin = 16;
export const danmakuSpeedMax = 32;
export const danmakuSpeedStep = 4;
